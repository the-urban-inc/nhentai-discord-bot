    ...
    async exec(interaction: CommandInteraction) {
        ...
        const qna = this.client.embeds
            ...
            .addFields([{
                ...
                value: '• `<<` / `>>` : Jumps to first/last embed | Jumps to previous/next page on nhentai ~~(only works for home, search, tag, artist, etc. commands)~~ (currently not working rn)\n' +
                ...
                value: '`Info View` / `Thumbnail View` / `Preview`: Toggles between text mode (with tags infos, artists infos, etc.)/big images mode/start reading the doujin.\n' +
                ...
                value: 'There are many possible reasons:\n' +
                ...
                value: 'Again, there are many possible reasons:\n' +
